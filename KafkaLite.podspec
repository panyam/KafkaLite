#
#  Be sure to run `pod spec lint KafkaLite.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/panyam/KafkaLite.git", :tag=> "V0.0.5" }
  ...
  s.source_files  = "KafkaLite", "src/*.{h,c}"
